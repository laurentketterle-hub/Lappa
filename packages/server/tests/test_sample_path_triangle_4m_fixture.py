"""Triangle 4m path fixture smoke."""
...
def test_sample_path_triangle_4m() -> None:
    p = Path(__file__).parent / "fixtures" / "sample_path_triangle_4m.json"
